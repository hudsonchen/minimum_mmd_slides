...
\begin{frame}{Part II: Sampling / Generative modelling}
    ...
    \begin{itemize}
        ...
        \begin{align*}
            \arg\min_{\Pb \in \calP(\R^d)} D(\Pb \mid \Qb) . 
        \end{align*}
...
\begin{frame}{Part II: Sampling / Generative modelling}
    ...
    \end{answerblock}
    \vspace{0.15cm}
    \centering \includegraphics[width=0.70\linewidth]{../plotting/figures/ot_wasserstein_gradient_illustration.pdf.pdf}\\[0.12cm]
\end{frame}
