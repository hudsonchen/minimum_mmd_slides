...
\begin{frame}
    ...
    {\normalsize A kernel-based way to compare probability distributions $\Pb$ and $\Qb$}\\[0.45cm]

    {\large\bfseries What can we use it for?}\\[0.35cm]

    \begin{columns}[T,onlytextwidth]
        \column{0.31\textwidth}
        \centering
        {\bfseries Numerical Integration}\\[0.12cm]
        {\Large $\Pb \stackrel{?}{=} \Qb$}\\[0.15cm]
        \includegraphics[width=\linewidth]{../figures/integral_illustration.pdf}

        \column{0.31\textwidth}
        \centering
        {\bfseries Sampling / generative modelling}\\[0.12cm]
        {\Large $X \sim \Qb_\theta \to \Pb$}\\[0.15cm]
    ...
    \vspace{0.3cm}
    {\small Next: MMD as both a diagnostic and an objective.}
