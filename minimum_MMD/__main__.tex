...
\begin{frame}{Part II: Sampling / Generative modelling}
    \begin{exampleblock}{}
        \centering \textbf{Challenge:}  Non-convexity of the squared MMD objective. 
    \end{exampleblock}
    \centering
    \setlength{\fboxsep}{2pt}
    \fcolorbox{mmdBlue!70!black}{mmdBlue!6}{%
    ...
    \fcolorbox{mmdGreen!70!black}{mmdGreen!6}{%
        \begin{minipage}[t][0.29\textheight][t]{0.95\linewidth}
            \centering
            {\footnotesize\bfseries SrMMD: Sobolev Regularized MMD Gradient Flow~\textcolor{mmdGreen!80!black}{(Arxiv)}}\\[0.02cm]
            {\scriptsize\textcolor{graytext}{C. Tian, B. K. Sriperumbudur, A. Gretton, \underline{Z. Chen}}}\\[0.04cm]
...
\begin{frame}{Part II: Sampling / Generative modelling}
    ...
    \fcolorbox{mmdRed!70!black}{mmdRed!6}{%
        \begin{minipage}[t][0.31\textheight][t]{0.95\linewidth}
            \centering
            {\footnotesize\bfseries Stationary MMD Points~\textcolor{mmdRed!80!black}{(ICML 2026)}}\\[0.02cm]
            {\scriptsize\textcolor{graytext}{\underline{Z. Chen}, T. Karvonen, H. Kanagawa, F.-X. Briol, C. J. Oates}}\\[0.04cm]
            ...
            \setlength\itemsep{1pt}
            \begin{itemize}
                \item Prove that samples from MMD flow are better for numerical integration. 
                \item IID samples: $\mathcal{O}(n^{-1/2})$, MMD points: $\mathcal{O}(n^{-1})$.
            \end{itemize}
        \end{minipage}
    }
    ...
    \fcolorbox{orange!80!black}{orange!7}{%
        \begin{minipage}[t][0.31\textheight][t]{0.95\linewidth}
            \centering
            {\footnotesize\bfseries TMFLD: Thinned Mean Field Langevin Dynamics~\textcolor{orange!80!black}{(ICML 2026)}}\\[0.02cm]
            {\scriptsize\textcolor{graytext}{\underline{Z. Chen}, H. Kanagawa, F.-X. Briol, C. J. Oates, L. Mackey}}\\[0.04cm]
        ...
        \fcolorbox{mmdBlue!70!black}{mmdBlue!8}{%
            \begin{minipage}[c][0.46\textheight][c]{0.84\linewidth}
                ...
                \begin{tikzpicture}[scale=0.62, every node/.style={font=\scriptsize}]
                    ...
                    \draw[-{Latex[length=2mm]}, thick, shorten <=1pt, shorten >=1pt] (theta.south east) -- (sim.north west);
                    \draw[-{Latex[length=2mm]}, thick, shorten <=1pt, shorten >=1pt] (sim.south east) -- (x.north west);
