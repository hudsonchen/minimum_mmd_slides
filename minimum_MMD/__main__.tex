...
\begin{frame}{Part I: Numerical Integration}
    \begin{itemize}
        ...
        \begin{align*}
            ...
            K(x_{1:n},x_{1:n})^{-1} . 
        \end{align*}
        \item The kernel quadrature (KQ) rule~\citep{rasmussen2002bayesian,sommariva2006numerical,briol2019probabilistic}: $\hat{I}_{\mathrm{KQ}} = \sum_{i=1}^n w_i f(x_i)$.
    \end{itemize}
\end{frame}
...
\begin{frame}{Part I: Numerical Integration}
    ...
    \begin{tabular}{@{}c@{\hspace{0.24cm}}c@{}}
        ...
        \begin{tabular}{@{}c@{\hspace{0.45cm}}c@{}}
            ...
            &
            \textbf{NKQ}~{\scriptsize\oldcitep{chen2025nested}}: $\Delta^{-d_{\calX}/s_{\calX}-d_{\Theta}/s_{\Theta}}$
            \\
            \bottomrule
        \end{tabular}}
    \end{tabular}
...
\begin{frame}{Part I: Numerical Integration}
    ...
    \begin{tabular}{@{}c@{\hspace{0.24cm}}c@{}}
        ...
        \begin{tabular}{@{}c@{\hspace{0.45cm}}c@{}}
            ...
            &
            \textbf{NKQ}~\citep{chen2025nested}: $\Delta^{-d_{\calX}/s_{\calX}-d_{\Theta}/s_{\Theta}}$
            \\
            \bottomrule
        \end{tabular}}
    \end{tabular}
