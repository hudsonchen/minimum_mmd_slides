...
\begin{frame}{About Me}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{minipage}[c][0.68\textheight][c]{\linewidth}
            \centering
            \begin{tikzpicture}
                \node[
...
\begin{frame}{Part I: Numerical Integration}
    \begin{answerblock}
        \centering \textbf{Rate:} KQ achieves $\mathcal{O}(n^{-s/d})$ rate.
    \end{answerblock}
    \begin{itemize}
        \item $s$ is the smoothness of $f$, $d$ is the dimension of input $x$. 
...
\begin{frame}{Part I: Numerical Integration}
    ...
    \fcolorbox{mmdGreen!70!black}{mmdGreen!6}{%
        \begin{minipage}[t][0.405\textheight][t]{0.95\linewidth}
            \centering
            {\bfseries Conditional Bayesian Quadrature~\textcolor{mmdGreen!80!black}{(UAI 2025)}}\\[0.02cm]
            {\footnotesize\textcolor{graytext}{\underline{Z. Chen}, M. Naslidnyk, A. Gretton, F.-X. Briol}}\\[0.04cm]

            \raggedright
            \begin{itemize}
                \item Extension to conditional expectations:
                $I(\theta)= \E_{X \sim p(\cdot \mid \theta)}[g(X,\theta)]$. 
                \item A weighted average over $T$ outer and $N$ inner samples:
                \begin{talign*}
    ...
    \fcolorbox{mmdBlue!70!black}{mmdBlue!6}{%
        \begin{minipage}[t][0.405\textheight][t]{0.95\linewidth}
            \centering
            {\bfseries Nested Expectations with Kernel Quadrature~\textcolor{mmdBlue!80!black}{(ICML 2025)}}\\[0.02cm]
            {\footnotesize\textcolor{graytext}{\underline{Z. Chen}, M. Naslidnyk, F.-X. Briol}}\\[0.04cm]
...
\begin{frame}{Part II: Sampling / Generative modelling}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item When $\Qb$ is known up to i.i.d samples, this is generative modelling.
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Part II: Sampling / Generative modelling}
    ...
    \fcolorbox{mmdBlue!70!black}{mmdBlue!6}{%
        \begin{minipage}[t][0.29\textheight][t]{0.95\linewidth}
            \centering
            {\bfseries (De)-regularized MMD Gradient Flow~\textcolor{mmdBlue!80!black}{(JMLR 2025)}}\\[0.02cm]
            {\footnotesize\textcolor{graytext}{\underline{Z. Chen}, A. Mustafi, P. Glaser, A. Korba, A. Gretton, B. K. Sriperumbudur}}\\[0.04cm]
    ...
    \fcolorbox{mmdGreen!70!black}{mmdGreen!6}{%
        \begin{minipage}[t][0.29\textheight][t]{0.95\linewidth}
            \centering
            {\bfseries Sobolev Regularized MMD Gradient Flow~\textcolor{mmdGreen!80!black}{(Arxiv)}}\\[0.02cm]
            {\footnotesize\textcolor{graytext}{C. Tian, B. K. Sriperumbudur, A. Gretton, \underline{Z. Chen}}}\\[0.04cm]
...
\begin{frame}{Part II: Sampling / Generative modelling}
    ...
    \fcolorbox{mmdRed!70!black}{mmdRed!6}{%
        \begin{minipage}[t][0.31\textheight][t]{0.95\linewidth}
            \centering
            {\bfseries Stationary MMD Points~\textcolor{mmdRed!80!black}{(ICML 2026)}}\\[0.02cm]
            {\footnotesize\textcolor{graytext}{\underline{Z. Chen}, T. Karvonen, H. Kanagawa, F.-X. Briol, C. J. Oates}}\\[0.04cm]

            \raggedright
            \begin{itemize}
                \item Prove that samples from MMD flow are better for numerical integration than IID samples. 
    ...
    \fcolorbox{orange!80!black}{orange!7}{%
        \begin{minipage}[t][0.31\textheight][t]{0.95\linewidth}
            \centering
            {\bfseries Thinned Mean Field Langevin Dynamics~\textcolor{orange!80!black}{(ICML 2026)}}\\[0.02cm]
            {\footnotesize\textcolor{graytext}{\underline{Z. Chen}, H. Kanagawa, F.-X. Briol, C. J. Oates, L. Mackey}}\\[0.04cm]
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \fcolorbox{mmdBlue!70!black}{mmdBlue!8}{%
            \begin{minipage}[c][0.46\textheight][c]{0.84\linewidth}
                ...
                {\bfseries Simulation-based\\inference}\\[0.02cm]
...
\begin{frame}{Part III: Statistical inference}
    ...
    \begin{minipage}[t][0.29\textheight][t]{0.95\linewidth}
        \centering
        {\bfseries On Optimization of Minimum MMD Estimators~\textcolor{mmdBlue!80!black}{(JMLR 2025)}}\\[0.02cm]
        {\footnotesize\textcolor{graytext}{S. S. Kang, L. Sharrock, X. Cheng, F.-X. Briol, \underline{Z. Chen}}}\\[0.04cm]
