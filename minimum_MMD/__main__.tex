...
\begin{frame}{Numerical Integration}
    ...
    \end{itemize}
    \centering
    \includegraphics[width=0.96\linewidth]{../figures/kq_smoothness_illustration.pdf}
\end{frame}

\begin{frame}{Numerical Integration}
    \centering
    \includegraphics[width=0.50\linewidth]{../figures/kq_single_expectation_benchmark.pdf}\\[-0.10cm]
...
\begin{frame}{Sampling / Generative modelling}
    \centering \includegraphics[width=0.4\linewidth]{../figures/illustration_sampling.pdf}\\[0.15cm]
    \begin{itemize}
        \item Given a distribution $\Pb$, how to sample from it?
        \begin{itemize}
            \item When $\Pb$ is known up to normalization, this is sampling.
            \item When $\Pb$ is known up to i.i.d samples, this is generative modelling.
        \end{itemize}
        \item MMD minimization: find a distribution $\Qb$ that minimizes $\mathrm{MMD}(\Pb, \Qb)$.
    \end{itemize}
\end{frame}
