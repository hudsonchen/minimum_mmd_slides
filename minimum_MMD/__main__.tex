...
\begin{frame}{Overview}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item for sampling / generative modelling.
            \item for statistical inference.
        \end{itemize}
...
\begin{frame}{Background: Maximum Mean Discrepancy (MMD)~\citep{gretton2012kernel}}
    ...
    \end{thm*}
    \begin{itemize}
        \item \textcolor{black!25}{MMD is a probability divergence ($\mathrm{MMD}(\Pb, \Qb)=0 \iff \Pb=\Qb$) if $k$ is characteristic (Gaussian)~\citep{sriperumbudur2011universality}.}
    \end{itemize}
    \endgroup
\end{frame}
