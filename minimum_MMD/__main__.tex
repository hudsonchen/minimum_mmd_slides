...
\left[f\left(\E_{X \sim \Pb_\theta}[g(X,\theta)]\right)\right].$
    ...
    \fcolorbox{mmdBlue!70!black}{mmdBlue!6}{%
        \begin{minipage}[t][0.195\textheight][t]{0.95\linewidth}
            \centering
            {\bfseries BayesSum: Bayesian Quadrature in Discrete Spaces~\textcolor{mmdBlue!80!black}{(ProbNum 2026)}}\\[0.02cm]
            {\footnotesize\textcolor{graytext}{S. S. Kang, F.-X. Briol, T. Karvonen, Z. Chen}}\\[0.04cm]
